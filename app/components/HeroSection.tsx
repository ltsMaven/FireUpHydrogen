        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <p className="text-xl text-gray-300 max-w-lg">
              Ignite your potential with FireUp – the ultimate energy drink designed
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div>
                <div className="text-3xl bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">
                  200mg
                </div>
          ...
          <div className="relative">
            <div className="relative">
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-t from-orange-500/30 to-transparent blur-3xl" />
              ...
              {/* Floating particles */}
              <div className="absolute bottom-10 left-1/4 w-2 h-2 bg-orange-400 rounded-full animate-bounce" />
              <div className="absolute bottom-20 right-1/4 w-3 h-3 bg-red-400 rounded-full animate-bounce" />
            </div>
          </div>
        </div>
      </div>
